...
*/
//add hmtl symbols from  http://www.amp-what.com/unicode/search/house
var HTMLheaderName = '<h1 id="name">%data%</h1>';
var HTMLheaderRole = '<span id="role">%data%</span><hr/>';
// add font icons (fa) insteaded of words from font-awesome
...
var HTMLgithub = '<li class="flex-item"><span class="orange-text"><i class="fa fa-github fa-2x"></i></span><span class="white-text">%data%</span></li>';
var HTMLblog = '<li class="flex-item"><span class="orange-text">blog</span><span class="white-text">%data%</span></li>';
var HTMLlocation = '<li class="flex-item"><span class="orange-text"><i class="fa fa-map fa-2x"></i> </span><span class="white-text">%data%</span></li>';
...
function logClicks(x,y) {
  ...
  // display the location in the js console
